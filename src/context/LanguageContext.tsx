...
const translations: Record<Language, Translations> = {
  sq: {
    ...
    account: 'Llogaria',
    cart: 'Shporta',
    newCollection: 'Koleksioni i Ri 2024',
    ...
    aboutParagraph1: 'Embroidery Elegance lindi nga pasioni për artin e qepjes. Kami fokus në veshje të bukura me detaje qepje të hollësuara.',
    aboutParagraph2: 'Emri ynë pasqyron misionin tonë—të sjellim elegancën e artizanisë në çdo veshje.',
    aboutParagraph3: 'Nga qëndisja delikate në fustanet tona deri tek detajet e sofistikuara, çdo aspekt është krijuar me pasion.',
    ...
    joinCommunity: 'Bashkohuni me Komunitetin Tonë',
    subscribeMessage: 'Abonohuni për oferta ekskluzive.',
    yourEmailAddress: 'Adresa juaj e email-it',
    subscribe: 'Abonohu',
    footerDescription: 'Duke festuar artin e qepjes me elegancë.',
  ...
  en: {
    ...
    aboutParagraph1: 'Embroidery Elegance was born from a passion for fine embroidery.',
    aboutParagraph2: 'Our name reflects our mission—to bring the elegance of fine artistry to every garment.',
    aboutParagraph3: 'From delicate embroidery on our dresses to sophisticated details on our tops, every element is crafted with passion.',
    ...
    subscribeMessage: 'Subscribe for exclusive offers.',
    yourEmailAddress: 'Your email address',
    subscribe: 'Subscribe',
    footerDescription: 'Celebrating the art of fine embroidery with elegance.',
  ...
  fr: {
    ...
    account: 'Compte',
    cart: 'Panier',
    newCollection: 'Nouvelle Collection 2024',
    ...
    aboutParagraph1: 'Embroidery Elegance est née d\'une passion pour la fine broderie.',
    aboutParagraph2: 'Notre nom reflète notre mission - apporter l\'élégance de l\'art raffiné à chaque vêtement.',
    aboutParagraph3: 'De la broderie délicate sur nos robes aux détails sophistiqués sur nos chemises, chaque élément est créé avec passion.',
    ...
    subscribeMessage: 'Abonnez-vous pour des offres exclusives.',
    yourEmailAddress: 'Votre adresse email',
    subscribe: 'S\'abonner',
    footerDescription: 'Célébrer l\'art de la fine broderie avec élégance.',
