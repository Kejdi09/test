...
const ProductCard = ({ product }: ProductCardProps) => {
  ...
  return (
    <div className="group card-product rounded-2xl shadow-md">
      <div className="relative aspect-[3/4] overflow-hidden bg-muted flex items-center justify-center rounded-2xl">
        <img
          src={productImage}
          alt={product.name}
